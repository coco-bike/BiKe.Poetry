...
namespace BiKe.Poetry.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See PoetryMigrationsDbContext for migrations.
     */
    [ConnectionStringName("Default")]
    public class PoetryDbContext : AbpDbContext<PoetryDbContext>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AppUser>(b =>
            {
                 ...
                 * Also see the PoetryEfCoreEntityExtensionMappings class
                 */
            });
